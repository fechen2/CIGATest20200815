...
namespace BlueRaja
{
        ...
        where TPriority : IComparable<TPriority>
    {
        ...
        public SimplePriorityQueue(int capacity) : this(Comparer<TPriority>.Default.Compare, EqualityComparer<TItem>.Default, capacity) { }
        ...
        public SimplePriorityQueue(Comparison<TPriority> priorityComparer, IEqualityComparer<TItem> itemEquality,int capacity)
        {
            _queue = new GenericPriorityQueue<SimpleNode, TPriority>(capacity, priorityComparer);
            _itemToNodesCache = new Dictionary<TItem, IList<SimpleNode>>(itemEquality);
            _nullNodesCache = new List<SimpleNode>();
        }
        #endregion
